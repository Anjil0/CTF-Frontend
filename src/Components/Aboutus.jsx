  ...
  const ContactForm = () => {
    ...
    return (
      <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
        <h2 className="text-gray-900 text-[32px] mb-1 font-bold title-font">
          Feedback
        </h2>
        <p className="leading-relaxed mb-5 text-gray-600">
          First Academy where you can showcase your skills
        </p>
        ...
        <p className="text-xs text-gray-500 mt-3">
          Step into the future of ING Skills.
        </p>
      </div>
    );
  };
    ...
    < NavBar/>
      <div className="relative overflow-hidden ">
        ...
        <div className="relative p-8 flex flex-col md:flex-row items-center mb- bg-white bg-opacity-70 backdrop-blur-lg">
          <div className="md:w-3/5 md:mr-4 md:mb-0">
            <h1 className="text-[60px] pl-3 font-bold text-gray-500">
              ABOUT US
            </h1>
            ...
            <p className="text-lg md:text-base leading-relaxed mb-6 text-justify font-sans pl-3 pr-20">
              ...
              Cupiditate ad cum, consectetur dolore saepe blanditiis nesciunt
              accusantium vero commodi officia!
            </p>
            <p className="text-md md:text-base leading-relaxed mb-6 text-justify font-sans pl-3 pr-20">
              ING Skill Academy is a comprehensive learning platform designed
              skills, though interactive modules, workshops, and practical train
              minima vitae rerum? resources and expert-led curriculum, ING Skill
              Academy equips its participants with the competencies needed to
              navigate challenges, drive business success, and adapt to evolving
              market trends. It serves as a catalyst for career advancement and
              organizational resilience, promoting a forward-thinking approach
              to skill development that aligns with ING's commitment to
              excellence and customer-centricity.
            </p>
            <a
              href="#"
              className="text-lime-500 font-bold ml-3 px-3 py-2 rounded-lg transition duration-300 hover:bg-gray-600 mb-7 sm:mb-5 md:mb-5 hover:text-lime-600"
            >
              GET IN TOUCH &rarr;
            </a>
          </div>
          <div
            className="w-full sm:w-3/5 md:w-2/5 rounded-lg bg-black h-[380px] bg-cover bg-center bg-no-repeat mt-5 rounded-tl-[99px] rounded-br-[99px]"
            style={{ backgroundImage: `url(${desk})` }}
          ></div>
        </div>
      </div>
      ...
      <div className="bg-white py-20 flex justify-center shadow-xl">
        <div className="w-full mx-auto text-center align-center">
          <h2 className="text-blue-600 uppercase tracking-widest mb-2">
            Our Team
          </h2>
      ...
      <Parallax
        bgImage="https://cdn.pixabay.com/photo/2016/01/14/20/14/desk-1140699_1280.jpg"
        strength={400}
      >
        <section
          ...
          style={{
            backgroundImage:
              "url(https://source.unsplash.com/1600x900/?testimonials)",
        ...
        >
          <div className="container px-5 py-24 mx-auto">
            <h1
              className="text-[65px] title-font text-gray

                             -900 mb-12 text-center font-black text-white uppercase"
            >
              Testimonials
            </h1>
              ...
              <div className="p-4 md:w-1/2 w-full">
                <div className="h-full bg-gray-100 p-8 rounded-[12px]">
                  ...
                  <p className="leading-relaxed mb-6">
                    I was totally surprised by the help of ING Skills Academy. ,
                    libero soluta earum iusto eaque provident, cumque voluptate
                    assumenda iure illo. Lorem ipsum dolor sit amet, consectetur
                    adipisicing elit.
                  </p>
                  <a className="inline-flex items-center">
                    <img
                      src="https://plus.unsplash.com/premium_photo-1679589214550-6028ebf28203?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTd8fGNhbWVyYXxlbnwwfHwwfHx8MA%3D%3D"
                      className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"
                    />
                    <span className="flex-grow flex flex-col pl-4">
                      <span className="title-font text-green-600 font-medium">
                        Saugat Ghimire
                      </span>
...
13.198-54.473-17.175-6.522-1.385-13.07-2.614-19.64-3.643l33.117-4.163c4.461-.58 8.855-1.716 13.112-3.393 4.259-1.676 8.393-4.047 12.26-7.081 3.866-3.034 7.437-6.682 10.543-10.838 3.105-4.157 5.621-8.842 7.381-13.936l34.17-97.77c4.325-12.379 8.771-24.584 13.02-36.814 7.524-21.53 18.88-41.881 33.422-60.302 14.541-18.421 32.213-34.505 52.331-47.737 13.49-8.976 27.762-16.618 42.63-22.888 20.055-8.438 40.956-14.814 62.514-19.073 7.018-1.376 14.06-2.532 21.118-3.479-3.229 1.729-6.52 3.385-9.854 4.98-7.86 3.607-15.68 7.547-23.317 11.872-19.515 11.142-38.129 23.591-55.558 37.288-17.43 13.696-33.178 28.615-47.159 44.583-14.095 16.027-26.149 32.973-36.057 50.724-7.914 14.391-14.922 29.221-20.888 44.385-5.965 15.164-11.11 30.621-15.415 46.281l-2.137 8.062z"
      ...
      <section className="text-gray-600 body-font ">
        <div className="container mx-auto flex px-[20px] py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">
              Step by step guide to capture the flag
            </p>
            ...
            <div className="flex lg:flex-row md:flex-col">
              ...
              <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-200 focus:outline-none">
                <svg
                  ...
                  viewBox="0 0 305 305"
                >
                  <path d="M40.74 112.12c-25.79 44.74-9.4 112.65 19.12 153.82C74.09 286.52 88.5 305 108.24 305c.37 0 .74 0 1.13-.02 9.27-.37 15.97-3.23 22.45-5.99 7.27-3.1 14.8-6.3 26.6-6.3 11.22 0 18.39 3.1 25.31 6.1 6.83 2.95 13.87 6 24.26 5.81 22.46-.39 36.47-19.9 48.12-37.15 13.27-19.66 18.79-38.79 21.09-47.43l.17-.65c.29-.97 5.04-17.43-.74-34.23-.45-1.31-3.88-11.3-16.7-16.13-4.14-1.51-9.57-2.6-15.55-2.6-6.41 0-12.95 1.35-17.61 2.6-4.34 1.14-8.07 2.13-11.38 2.13-4.88 0-9.16-1.2-13.29-2.46-6.13-1.93-12.5-3.96-22.62-3.96-11.61 0-19.99 2.69-26.72 5.23-5.06 1.9-9.4 3.52-13.69 3.52-5.19 0-10.93-2.06-17.7-6.08-7.43-4.5-13.62-11.12-18.94-19.08-6.18-9.27-10.9-19.04-14.51-27.61-3.72-8.81-6.86-17.37-10.96-25.36zM217.6 1.73c-13.59.55-29.85 9.05-39.53 21.54-8.48 11.05-14.63 26.79-12.73 42.16.37 2.89.9 5.75 1.54 8.47 1.38 5.97 3.62 11.69 6.26 17.08 3.18 6.34 7.33 13.67 12.6 19.2 6.58 6.9 14.47 11.4 23.21 11.03 11.65-.5 23.88-6.96 31.64-16.92 8.7-10.88 14.48-25.97 12.25-40.89-.45-2.77-.92-5.42-1.5-8.08-1.34-6.12-3.51-12.08-6.22-17.73-3.13-6.51-7.3-13.77-12.61-19.36-6.83-7.07-15.54-11.59-24.87-11.5z"></path>
                </svg>
                <span className="ml-4 flex items-start flex-col leading-none">
          ...
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a
                  href="mailto:ingskillsacademy@iic.edu.np"
